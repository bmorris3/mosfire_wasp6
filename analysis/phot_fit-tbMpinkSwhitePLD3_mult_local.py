...
if gpon:
    if gpred: 
        paramlimits = [[0.07, 0.11],  #aRs
                       ...
                       Nbins*[[-20, 20]] + Nbins*[[0, 0.5]] # GP hyperparams
...
from moar import stats
path = '/astro/store/scratch/tmp/bmmorris/longchains/mosfirespitzer/phot_fit-tbMpinkSwhitePLD3_mult201503141456/chains.dat'
